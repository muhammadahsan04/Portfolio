...
//       {/* <div className="absolute xs:bottom-3 bottom-20 right-4 w-full flex justify-end items-center">
//         <a href="#about">
...
// const Hero = () => {
//   return (
//     <section className="relative w-full h-screen mx-auto max-md:mb-[80px] border">
//       <div
//         className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5 border-2`}
//       >
//         <div className="flex justify-between max-md:flex-col max-md:gap-8 max-lg:justify-around w-full flex-wrap lg:flex-row max-md:items-center">
//           <div className="flex">
//             <div className="flex flex-col justify-start items-center mt-5 mr-2">
